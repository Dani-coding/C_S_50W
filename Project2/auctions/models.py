...
class Bid(models.Model):
    ...
    ad = models.ForeignKey(Ad, on_delete=models.CASCADE, related_name="bidded", blank=False)
...
class Comment(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="commenter", blank=False)
    ad = models.ForeignKey(Ad, on_delete=models.CASCADE, related_name="commented", blank=False)
